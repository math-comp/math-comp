...
opam install coq -j3
opam install coq-mathcomp-base -j3
```
Replace `base` here by the package you want, the dependencies will be
...
opam install coq-mathcomp-base.dev -j3
```
...
```
opam pin add -n -k path coq-mathcomp-base .
```
