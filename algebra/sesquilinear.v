...
Elpi mlock Definition form_of_matrix (R : fieldType) (n : nat) (theta : R -> R)
  m M (U V : 'M_(m, n)) := \tr (U *m M *m (V ^t theta)).
...
Proof.
by rewrite qualifE /= powr0n scale1r tr_scalar_mx map_scalar_mx/= conjC1.
Qed.
