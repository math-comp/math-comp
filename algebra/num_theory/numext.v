...
From mathcomp Require Import all_boot all_order ssralg orderedzmod zmodext.
From mathcomp Require Import numdomain numfield interval_inference.
...
move: x => [x|_|//].
  ...
  - by move=> _; rewrite ![_ * x%:E]mulr_infty gtr0_sg// 2!mul1e.
move=> [y| |] [z| |]//; first last.
