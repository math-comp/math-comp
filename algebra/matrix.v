...
Proof.
elim: k=> [|k IHk]; first by rewrite !powr0n -scalar_mx_block.
rewrite !powrS IHk [LHS](mulmx_block A _ _ _ (A ^+ k)).
...
Proof. by rewrite -(scale0r 0) detZ powrS !mul0r. Qed.
...
by rewrite -powrSr prednK // !mulrA divrK ?unitrX.
Qed.
