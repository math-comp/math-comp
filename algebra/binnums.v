...
From micromega_plugin Require Import PosDef.
...
Proof.
move: qr q'r' => /QratP[n d qn qd ->] /QratP[n' d' qn' qd' ->] {r r'}.
rewrite ler_pdivrMr 1?mulrAC; first by rewrite ltr0n -(eqP qd) Pos_to_nat_gt0.
rewrite ler_pdivlMr; first by rewrite ltr0n -(eqP qd') Pos_to_nat_gt0//.
