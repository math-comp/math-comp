...
Proof.
elim: m => [|m IHm] x Gx; rewrite /= ?repr_mx1 // expgS pownrS -IHm //.
...
by rewrite expgS irr_modeM ?groupX // pownrS IHn.
Qed.
...
by rewrite pownrSr mulmxA (submx_trans (submxMr A IHk)).
Qed.
...
by rewrite eval_mulT pownrS IH1 IHn1.
Qed.
