...
Proof.
elim: n=> [|n] /=; first by rewrite powr0n mulr1 mul0r add0r.
by move->; rewrite addr0 -mulrA -powrSr.
Qed.
...
- by [].
- elim: n h => [|n ihn] rt; first by rewrite /= powr0n mul0r add0r hornerC.
  by rewrite /= eval_mulpT powrSr hornerM ihn // mulrC tP.
Qed.
