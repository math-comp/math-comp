...
rewrite rmorphXn /= pownrAC -Dz -Dnu /= -{1}[zn]hornerX /phi.
...
have SmulX (i : 'I_m): {in S, forall x, x * X`_i \in S}.
  ...
  rewrite mulrzAl rpredMz {x}// nth_image mulrC (bigD1 i) //= mulrA -pownrS.
...
by rewrite pownrS mulrA IHe // SmulX.
Qed.
...
Proof.
apply/idP/eqP=> [|x_n_1]; first by apply: pownr_dvd; apply: exp_orderC.
