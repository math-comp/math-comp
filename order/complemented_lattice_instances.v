...
(*                                                                            *)
(* This file provides instances of order structure (complemented lattices or  *)
(* below) on the following types:                                             *)
(* - T *prod[disp] T' (for product order),                                    *)
(* - n.-tupleprod[disp] (for product order), and                              *)
(* - {subset[disp] T} (for subset order).                                     *)
...
Module DefaultSetSubsetOrder := Order.DefaultSetSubsetOrder.
