...
(*                                                                            *)
(* This file provides following aliases for types and their displays:         *)
(*     T *lexi[d] T' := T * T'                                                *)
...
(*                                                                            *)
(* This file provides instances of order structure (total orders or below) on *)
(* the following types:                                                       *)
(* - nat (for leq),                                                           *)
(* - 'I_n (equipped with top and bottom when n := n'.+1),                     *)
(* - {t : T & T' x} (for lexicographic ordering),                             *)
(* - T *lexi[disp] T' (for lexicographic ordering),                           *)
(* - seqlexi_with d T (for lexicographic ordering), and                       *)
(* - n.-tuplelexi[d] T (for lexicographic ordering).                          *)
...
End LexiSyntax.
HB.export LexiSyntax.

Module SeqLexiSyntax.
...
Import Order.Theory Order.EnumVal.
