...
ENV MATHCOMP_PACKAGE="coq-mathcomp-group-representation"
...
RUN set -x \
  ...
  && opam pin add -n -y -k path rocq-mathcomp-group . \
  ...
  && opam pin add -n -k path coq-mathcomp-group . \
  ...
  && opam pin add -n -k path coq-mathcomp-group-representation . \
