...
Lemma comparable_min_le_min : x <= z -> y <= w ->
...
Lemma comparable_max_le_max : x <= z -> y <= w ->
...
Lemma min_le_min x y z t : x <= z -> y <= t -> Order.min x y <= Order.min z t.
Proof. exact: comparable_min_le_min. Qed.

Lemma max_le_max x y z t : x <= z -> y <= t -> Order.max x y <= Order.max z t.
