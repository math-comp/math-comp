...
Notation "''Ldiv_' n ()" := (Ldiv _ n)
  (at level 0, n at level 2, format "''Ldiv_' n ()") : group_scope.

Notation "''Ldiv_' n ( G )" := (G :&: 'Ldiv_n())
  (at level 0, n at level 2, format "''Ldiv_' n ( G )") : group_scope.
...
Notation "''E_' p ( G )" := (pElem p G)
  (at level 0, p at level 2, format "''E_' p ( G )") : group_scope.

Notation "''E_' p ^ n ( G )" := (pnElem p n G)
  (at level 0, p, n at level 2, format "''E_' p ^ n ( G )") : group_scope.

Notation "''E' ^ n ( G )" := (nElem n G)
  (at level 0, n at level 2, format "''E' ^ n ( G )") : group_scope.

Notation "''E*_' p ( G )" := (pmaxElem p G)
  (at level 0, p at level 2, format "''E*_' p ( G )") : group_scope.

Notation "''m' ( A )" := (gen_rank A)
  (at level 0, format "''m' ( A )") : group_scope.

Notation "''r' ( A )" := (rank A)
  (at level 0, format "''r' ( A )") : group_scope.

Notation "''r_' p ( A )" := (p_rank p A)
  (at level 0, p at level 2, format "''r_' p ( A )") : group_scope.
...
Notation "''Ohm_' n ( G )" := (Ohm n G)
  (at level 0, n at level 2, format "''Ohm_' n ( G )") : group_scope.
Notation "''Ohm_' n ( G )" := (Ohm_group n G) : Group_scope.

Notation "''Mho^' n ( G )" := (Mho n G)
  (at level 0, n at level 2, format "''Mho^' n ( G )") : group_scope.
