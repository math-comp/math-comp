...
Reserved Notation "p .1" (at level 2, left associativity, format "p .1", only parsing).
Reserved Notation "p .2" (at level 2, left associativity, format "p .2", only parsing).
Reserved Notation "f ^~ y" (at level 10, y at level 8, no associativity,
  format "f ^~  y", only parsing).
Reserved Notation "@^~ x" (at level 10, x at level 8, no associativity,
  format "@^~  x", only parsing).
Reserved Notation "[ 'eta' f ]" (at level 0, format "[ 'eta'  f ]", only parsing).
Reserved Notation "'fun' => E" (at level 200, format "'fun' =>  E", only parsing).
