...
(* One characterstic of ordered types is that one carrier type may have       *)
(* several orders. For example, natural numbers can be totally or partially   *)
(* ordered by the less than or equal relation, the divisibility relation, and *)
(* their dual relations. Therefore, we need a way to control inference of     *)
(* ordered type instances and printing of generic relations and operations on *)
(* ordered types. As a rule of thumb, we use a carrier type or its alias      *)
(* (named copy) to control inference, and use a "display" to control the      *)
(* printing of notations.                                                     *)
(*                                                                            *)
(* Each generic interface and operation for ordered types has, as its first   *)
(* argument, a "display" of type Order.disp_t to control the printing of      *)
(* notations. For example, the less than or equal relation has type:          *)
...
(* natdvd of nat; such an inference should be triggered through the use of    *)
(* the corresponding type alias, i.e., (m : natdvd) %| n. In other words,     *)
