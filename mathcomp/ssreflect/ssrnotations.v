...
Reserved Notation "e .[ x1 , x2 , .. , xn ]" (at level 1, left associativity,
  format "e '[ ' .[ x1 , '/'  x2 , '/'  .. , '/'  xn ] ']'").
...
Reserved Notation "''C' [ x ]" (at level 0, format "''C' [ x ]").
Reserved Notation "''C_' A [ x ]"
  (at level 0, A at level 2, format "''C_' A [ x ]").
Reserved Notation "''C' ( A )" (at level 0, format "''C' ( A )").
Reserved Notation "''C_' B ( A )"
  (at level 0, B at level 2, format "''C_' B ( A )").
Reserved Notation "''Z' ( A )" (at level 0, format "''Z' ( A )").
(* Compatibility with group action centraliser notation. *)
Reserved Notation "''C_' ( A ) [ x ]" (at level 0).
Reserved Notation "''C_' ( B ) ( A )" (at level 0).
Reserved Notation "''C' [ x | to ]" (at level 0, format "''C' [ x | to ]").
Reserved Notation "''C' ( S | to )" (at level 0, format "''C' ( S | to )").
Reserved Notation "''C_' A [ x | to ]"
  (at level 0, A at level 2, format "''C_' A [ x  |  to ]").
Reserved Notation "''C_' A ( S | to )"
  (at level 0, A at level 2, format "''C_' A ( S  |  to )").
Reserved Notation "''C_' ( A ) [ x | to ]" (only parsing, at level 0).
Reserved Notation "''C_' ( A ) ( S | to )" (only parsing, at level 0).
Reserved Notation "''C_' ( | to ) [ a ]"
  (at level 0, format "''C_' ( | to ) [ a ]").
Reserved Notation "''C_' ( G | to ) [ a ]"
  (at level 0, format "''C_' ( G  |  to ) [ a ]").
Reserved Notation "''C_' ( | to ) ( A )"
  (at level 0, format "''C_' ( | to ) ( A )").
Reserved Notation "''C_' ( G | to ) ( A )"
  (at level 0, format "''C_' ( G  |  to ) ( A )").
...
Reserved Notation "''C' ( n , m )" (at level 0, n, m at level 200, format "''C' ( n ,  m )").
...
Reserved Notation "a ^` ( n )" (at level 1, format "a ^` ( n )").
