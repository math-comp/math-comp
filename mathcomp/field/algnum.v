...
have nu0m : multiplicative1first nu0.
...
pose nu0mM := GRing.isMultiplicative1first.Build Qn Qn nu0 nu0m.
...
- pose b0 := vbasis {:Sdom mu0}.
  ...
  have{ps Ds} [in01 Din01]:
    ...
    have in01m : multiplicative1first in01.
    ...
    pose in01mM := GRing.isMultiplicative1first.Build _ _ in01 in01m.
  ...
  pose f1mM := GRing.isMultiplicative1first.Build _ _ f1 (kHom_lrmorphism aut_f1).
...
have num : multiplicative1first nu.
...
pose numM := GRing.isMultiplicative1first.Build _ _ nu num.
...
have phim : multiplicative1first phi.
  by apply/kHom_lrmorphism; rewrite -genQn span_seq1 /= kHomExtendP.
pose phimM := GRing.isMultiplicative1first.Build _ _ phi phim.
