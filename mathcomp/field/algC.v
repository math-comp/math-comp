...
Lemma nz2: 2 != 0 :> L.
Proof.
  apply/eqP=> char'2; apply: conj_nt => e; apply/eqP/idPn=> eJ.
  have opp_id x: - x = x :> L.
    by apply/esym/eqP; rewrite -addr_eq0 -mulr2n -mulr_natl char'2 mul0r.
  have{} char'2: 2%N \in [char' L] by apply/eqP.
  ...
  have Db2: b ^+ 2 + b = a.
    rewrite -Frobenius_aut'E // rmorphD addrACA Dw /= Frobenius_aut'E -rmorphXn.
...
Definition Cchar' : [char' algC] =i pred0 := @char'_num _.
...
#[deprecated(since="mathcomp 2.4.0", note="Use Cchar' instead.")]
Notation Cchar := (Cchar') (only parsing).
