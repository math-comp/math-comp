...
have char'Q (L : Qfield): [char' L] =i pred0 := ftrans (char'_lalg L) (char'_num _).
have sepQ  (L : Qfield) (K E : {subfield L}): separable K E.
  by apply/separableP=> u _; apply: char'f0_separable.
...
have PET2 x y: {z | gen z x & gen z y}.
  ...
  have [n [[p Dx] [q Dy]]] := char'0_PET nz_px pxx0 nz_py pyy0 (char'_num _).
...
have /all_sig[n_ FTA] z: {n | z \in sQ (z_ n)}.
  ...
  have nz2: 2 != 0 :> Qt by move/char'f0P: (char'Q (Q t)) => ->.
...
by have /char'f0P-> := ftrans (fmorph_char' QtoC) (char'_num _).
Qed.
