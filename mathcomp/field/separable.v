...
have [[p pcharLp]|] := altP (separablePn' K x); last by rewrite negbK; exists 1.
...
Proof.
move=> pcharL0 x; have [n /andP[pcharLn]] := separable_exponent' K x.
...
Proof.
move/subvP=> sKE /purely_inseparable_elementP'[n pcharLn /sKE Exn].
...
Proof.
move=> sepKx_y; have [n /andP[pcharLn sepKyn]] := separable_exponent' K y.
...
case/purely_inseparable_elementP'=> n pcharLn K_Ein.
