...
HB.instance Definition _ (g : [subg G]) :=
  GRing.isLinear.Build 'F_p rVn rVn _ (abelem_mx_fun g)
...
Hypothesis char'Fp : p \in [char' F].
...
have p_pr: prime p by case/andP: char'Fp.
...
have char'Mp: p \in [char' 'M[F]_n].
  exact: (rmorph_char' (@scalar_mx F n)).
have{Urz1}: Frobenius_aut' char'Mp (rG z - 1) \in GRing.unit by rewrite unitrX.
rewrite (Frobenius_aut'B_comm _ (commr1 _)) Frobenius_aut'1.
...
#[deprecated(since="mathcomp 2.4.0", note="Use rfix_pgroup_char' instead.")]
Notation rfix_pgroup_char := (rfix_pgroup_char') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use pcore_sub_rstab_mxsimple' instead.")]
Notation pcore_sub_rstab_mxsimple := (pcore_sub_rstab_mxsimple') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use pcore_sub_rker_mx_irr' instead.")]
Notation pcore_sub_rker_mx_irr := (pcore_sub_rker_mx_irr') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use pcore_faithful_mx_irr' instead.")]
Notation pcore_faithful_mx_irr := (pcore_faithful_mx_irr') (only parsing).
...
#[deprecated(since="mathcomp 2.4.0", note="Use extraspecial_repr_structure' instead.")]
Notation extraspecial_repr_structure := (extraspecial_repr_structure') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use faithful_repr_extraspecial' instead.")]
Notation faithful_repr_extraspecial := (faithful_repr_extraspecial') (only parsing).
