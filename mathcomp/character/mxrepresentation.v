...
Lemma mx_Maschke' : [pchar F]^'.-group G -> mx_completely_reducible 1%:M.
Proof.
...
Proof.
by move=> neq_ij /(irr_comp'_op0' _)->; [|apply: socle_irr|rewrite irr_reprK'].
Qed.
...
#[deprecated(since="mathcomp 2.4.0", note="Use mx_Maschke' instead.")]
Notation mx_Maschke := (mx_Maschke') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use rsim_regular_submod' instead.")]
Notation rsim_regular_submod := (rsim_regular_submod') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use irr_mx_sum' instead.")]
Notation irr_mx_sum := (irr_mx_sum') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use Wedderburn_sum' instead.")]
Notation Wedderburn_sum := (Wedderburn_sum') (only parsing).
...
#[deprecated(since="mathcomp 2.4.0", note="Use rsim_irr_comp' instead.")]
Notation rsim_irr_comp := (rsim_irr_comp') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use irr_comp'_op0' instead.")]
Notation irr_comp'_op0 := (irr_comp'_op0') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use irr_comp_envelop' instead.")]
Notation irr_comp_envelop := (irr_comp_envelop') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use ker_irr_comp_op' instead.")]
Notation ker_irr_comp_op := (ker_irr_comp_op') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use regular_op_inj' instead.")]
Notation regular_op_inj := (regular_op_inj') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use rank_irr_comp' instead.")]
Notation rank_irr_comp := (rank_irr_comp') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use irr_comp_rsim' instead.")]
Notation irr_comp_rsim := (irr_comp_rsim') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use irr_reprK' instead.")]
Notation irr_reprK := (irr_reprK') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use irr_repr'_op0' instead.")]
Notation irr_repr'_op0 := (irr_repr'_op0') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use op_Wedderburn_id' instead.")]
Notation op_Wedderburn_id := (op_Wedderburn_id') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use irr_comp_id' instead.")]
Notation irr_comp_id := (irr_comp_id') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use rank_Wedderburn_subring' instead.")]
Notation rank_Wedderburn_subring := (rank_Wedderburn_subring') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use sum_irr_degree' instead.")]
Notation sum_irr_degree := (sum_irr_degree') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use irr_mx_mult' instead.")]
Notation irr_mx_mult := (irr_mx_mult') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use mxtrace_regular' instead.")]
Notation mxtrace_regular := (mxtrace_regular') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use linear_irr_comp' instead.")]
Notation linear_irr_comp := (linear_irr_comp') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use Wedderburn_subring_center' instead.")]
Notation Wedderburn_subring_center := (Wedderburn_subring_center') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use Wedderburn_center' instead.")]
Notation Wedderburn_center := (Wedderburn_center') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use card_irr' instead.")]
Notation card_irr := (card_irr') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use cycle_repr_structure' instead.")]
Notation cycle_repr_structure := (cycle_repr_structure') (only parsing).
#[deprecated(since="mathcomp 2.4.0", note="Use splitting_cyclic_primitive_root' instead.")]
Notation splitting_cyclic_primitive_root := (splitting_cyclic_primitive_root') (only parsing).
