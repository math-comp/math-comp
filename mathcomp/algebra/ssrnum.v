...
Lemma char'_num : [char' R] =i pred0.
...
#[deprecated(since="mathcomp 2.4.0",note="Use char'_num instead.")]
Notation char_num := char'_num (only parsing).
...
Proof. by apply: char'0_natf_div; apply: (@char'_num F). Qed.
