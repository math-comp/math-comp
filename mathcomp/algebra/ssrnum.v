...
have sz_p: size p = n.+1.
  rewrite size_addl ?size_polyXn // ltnS sizeN size_polyC mulrn_eq0.
...
Let degpN : size (- p) = 3. Proof. by rewrite sizeN. Qed.
...
apply/(iffP idP) => [dlt0 x | /(_ r1)].
  ...
  apply/lt0r_neq0/deg2_poly_gt0; rewrite ?sizeN ?coefN ?oppr_ge0 ?ltW//.
...
rewrite -!coefN deg_le2_poly_delta_ge0 ?sizeN ?coefN ?oppr_ge0// => x.
...
by rewrite -!coefN deg_le2_poly_ge0 ?sizeN// => x; rewrite hornerN oppr_ge0.
Qed.
