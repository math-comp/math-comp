...
by rewrite (le_lt_trans (ler_wpmul2r x2ge0 (ltW lt_xy1))) ?ltrpM2l.
Qed.
...
rewrite (@le_lt_trans _ _ (x * y ^+ n.+1)) ?ler_wpmul2l ?ltrpM2r ?IHn //.
  by rewrite ltW // ihn.
...
rewrite normrM normrX ler_wpmul2l ?lerX2r ?unfold_in //.
