...
Proof. by []. Qed.
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun {poly_n R} {poly R} _ (polyn (n:=n))
...
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly_(size (mk_monic h)).-1 R} _
    in_qpoly (GRing.semilinear_linear in_qpoly_is_linear).
