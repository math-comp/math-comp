...
HB.instance Definition _ m n p q f g k :=
  GRing.isSemiScalable.Build R R idfun 'M[R]_(m, n) 'M[R]_(p, q) *:%R
    (swizzle_mx f g k) (swizzle_mx_is_scalable f g k).
...
HB.instance Definition _ m n :=
  GRing.isSemiScalable.Build R R idfun 'M_(m, n) 'rV_(m * n) *:%R mxvec
...
HB.instance Definition _ n :=
  GRing.isSemilinear.Build R R idfun 'rV_n 'M_n _ (@diag_mx _ n)
...
HB.instance Definition _ B :=
  GRing.isSemilinear.Build R R idfun 'M_(m, n) 'M_(m, p) _ (mulmxr B)
...
Qed.
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun 'M_(n, p) 'M_(m * n, m * p) _ lin_mulmxr
...
Qed.
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun 'M_n R _ (@mxtrace _ n)
...
HB.instance Definition _ A :=
  GRing.isSemiScalable.Build R R idfun 'M[R]_(n, p) 'M[R]_(m, p) *:%R (mulmx A)
    (mulmx_is_scalable A).
...
Qed.
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun 'M[R]_(m, n) 'M[R]_(n * p, m * p) _
    lin_mulmx (GRing.semilinear_linear lin_mulmx_is_linear).
...
Qed.
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun _ _ _ lin_mul_row
