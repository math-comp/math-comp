...
HB.structure Definition NzSemiRing := { R of Nmodule_isNzSemiRing R & Nmodule R }.
...
Variables (R : nzRingType) (A B : lalgType R) (C : nzRingType) (s : R -> C -> C).
...
Notation "[ 'SubNzRing_SubLmodule_isSubLalgebra' 'of' U 'by' <: ]" :=
  ...
  (at level 0, format "[ 'SubNzRing_SubLmodule_isSubLalgebra'  'of'  U  'by'  <: ]")
  : form_scope.
