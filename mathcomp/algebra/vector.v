...
Reserved Notation "''Hom' ( T , rT )" (at level 0, format "''Hom' ( T ,  rT )").
Reserved Notation "''End' ( T )" (at level 0, format "''End' ( T )").
...
Notation "U ^C" := (complv U) (at level 1, format "U ^C") : vspace_scope.
