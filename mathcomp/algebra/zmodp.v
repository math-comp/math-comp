...
#[deprecated(since="mathcomp 2.4.0", note="Use char'_Zp instead.")]
Notation char_Zp := (char'_Zp) (only parsing).
...
Lemma char'_Fp : p \in [char' 'F_p].
Proof. by rewrite !inE -Fp_nat_mod p_pr ?modnn. Qed.

Lemma char'_Fp_0 : p%:R = 0 :> 'F_p.
Proof. exact: GRing.char'f0 char'_Fp. Qed.
...
#[deprecated(since="mathcomp 2.4.0", note="Use char'_Fp instead.")]
Notation char_Fp := (char'_Fp) (only parsing).

#[deprecated(since="mathcomp 2.4.0", note="Use char'_Fp_0 instead.")]
Notation char_Fp_0 := (char'_Fp_0) (only parsing).
