...
HB.instance Definition _ i :=
  GRing.isSemiScalable.Build R R idfun {poly R} R *%R (coefp i)
    (fun a => (coefZ a) ^~ i).
...
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly R} _ deriv
...
HB.instance Definition _ n :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly R} _ (derivn n)
...
Qed.
HB.instance Definition _ n :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly R} _ (nderivn n)
...
HB.instance Definition _ :=
  GRing.isSemiScalable.Build aR aR idfun {poly aR} {poly rR}
    (f \; *:%R) (map_poly f) map_polyZ.
...
HB.instance Definition _ :=
  GRing.isSemilinear.Build aR aR idfun {poly aR} rR _ (horner_morph cfu)
...
HB.instance Definition _ p :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly R} _ (comp_poly p)
...
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly R} _ even_poly
...
HB.instance Definition _ :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly R} _ odd_poly
...
HB.instance Definition _ m :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly R} _ (take_poly m)
...
HB.instance Definition _ m :=
  GRing.isSemilinear.Build R R idfun {poly R} {poly R} _ (drop_poly m)
...
HB.instance Definition _ x :=
  GRing.isSemilinear.Build R R idfun {poly R} R _ (horner_eval x)
